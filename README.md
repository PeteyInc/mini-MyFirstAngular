...
- In your 'index.html' file create a basic skeleton of your application. Be sure to include the following
  ...
  - A link to your 'styles.css' file in your section
  - **CSS files always go in your section while JavaScript files will always go before the closing tag.**
